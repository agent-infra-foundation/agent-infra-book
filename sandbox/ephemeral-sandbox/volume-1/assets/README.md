...
Part 0 uses ten finished figures: one conceptual raster illustration and nine
editable SVG diagrams. No figure depends on Mermaid or another runtime
diagram renderer.
...
| 4.1 | 4 | [RL Environment Stack](diagrams/part-0/04-rl-environment-stack.svg) | SVG | Show the five components that turn an attempt into a scored episode |
...
| 6.1 | 6 | [Meta-Agent, Control Plane, and Fleet](diagrams/part-0/06-agent-control-plane-fleet.svg) | SVG | Separate supervision, lifecycle, placement, execution, and durable evidence |
...
All technical figures use a 1600 × 900 canvas and the same semantic palette:
...
- Prefer the SVG directly for web, EPUB, and modern PDF production.
