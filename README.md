...
[Book overview →](cloudflare/computer/README.md)

| Article | English | 简体中文 |
|---|---|---|
| Part I — Introducing Cloudflare Durable Objects | [Read](cloudflare/computer/chapters/PART-I.md) | [阅读](cloudflare/computer/chapters/PART-I.zh-CN.md) |
| Part II — Cloudflare Computer: How to Cut AI Agent Sandboxing Costs by 80% | [Read](cloudflare/computer/chapters/PART-II.md) | [阅读](cloudflare/computer/chapters/PART-II.zh-CN.md) |
| Part III — Transforming Cloudflare Computer: 98.4% Less Branch Storage, 3.18× Faster Edits, and Safe Multi-Agent Parallelism | [Read](cloudflare/computer/chapters/PART-III.md) | [阅读](cloudflare/computer/chapters/PART-III.zh-CN.md) |
